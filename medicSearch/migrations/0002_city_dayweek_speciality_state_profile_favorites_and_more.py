...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='profile',
            name='role',
            field=models.IntegerField(choices=[(1, 'Admin'), (2, 'Médico'), (3, 'Paciente')], default=3),
        ),
        migrations.CreateModel(
            name='Rating',
            fields=[
        ...
        migrations.AddField(
            model_name='profile',
            name='speciality',
            field=models.ManyToManyField(blank=True, related_name='speciality', to='medicSearch.speciality'),
        ),
    ]
